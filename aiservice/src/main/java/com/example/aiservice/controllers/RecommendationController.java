...
import com.example.aiservice.services.RecommendationService;
...
public class RecommendationController {
    ...
    public ResponseEntity<Recommendation> getActivitiyRecommendations(@PathVariable String activityId){
